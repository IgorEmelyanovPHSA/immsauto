...
public class BulkTransfers extends BaseTest {
	...
	@Test
	public void Can_do_Bulk_transfers_by_Dosages_form_one_Clinic_to_Another_as_PPHIS_BCVAXUAT() throws InterruptedException {
		TestcaseID = "222358";
		...
		//log("/*---     record number: " +kk);
		//log("/*12.3---Click on Supply Transaction STRX-... Related Tab --*/");
		//supplyConsolePagePage.clickSupplyTransactionRelatedTab();
		//Thread.sleep(2000);
		//log("/*12.4---Get Outgoing Transaction id 'form' --*/");
		//String outgoingShipmentTransactionId = supplyConsolePagePage.getSupplyShipmentTransactionId();
		//log("/*--outgoing Shipment Transaction id --*/:" +outgoingShipmentTransactionId);
		//log("/*12.5---Click on Supply Shipment name SSHP-... --*/");
		//supplyConsolePagePage.clickOnSupplyShipmentName();
		//Thread.sleep(2000);
		//log("/*12.6---Get Outgoing Transaction id 'form' --*/");
		////String outgoingId;
		////String outgoingSupplyTransactionId = supplyConsolePagePage.getOutgoingSupplyTransactionId();
		////log("/*--outgoing Supply Transaction From id --*/:" +outgoingSupplyTransactionId);
		//Thread.sleep(2000);
		//log("/*12.7---Get Incoming Transaction id 'to' --*/");
		//Thread.sleep(2000);
		////nn++;
		////}
		Thread.sleep(3000);

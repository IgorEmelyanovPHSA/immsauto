...
public class CitizenDuplicates extends BaseTest {
	...
	public void Can_search_and_remove_Citizen_participant_account() throws InterruptedException {
		...
		inClinicExperiencePage.SearchForCitizen("BARBIE MIDDLENAMELABB Labflastnametestroberts");
		System.out.println("/*----Search for Barbie is Successful ---*/");
		if (!inClinicExperiencePage.userFound()) {
			System.out.println("/*----User --> Barbie not found and return---*/");
		}

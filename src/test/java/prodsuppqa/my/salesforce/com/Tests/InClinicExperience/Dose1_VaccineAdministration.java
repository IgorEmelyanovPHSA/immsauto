...
public class Dose1_VaccineAdministration extends BaseTest {
	...
	@Test(priority = 2)
	public void Can_do_Dose1_Vaccine_Administration_as_Clinician_ICE_PRODSUPPQA() throws InterruptedException {
		...
		Thread.sleep(5000);
		System.out.println("/*-- 43---select Vaccine Agent  COVID-19 mRNA --*/");

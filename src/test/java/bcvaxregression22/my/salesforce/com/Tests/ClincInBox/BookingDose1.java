package bcvaxregression22.my.salesforce.com.Tests.ClincInBox;

import bcvaxregession22.my.salesforce.com.Pages.ClinicInBoxPage;
import bcvaxregession22.my.salesforce.com.Pages.InClinicExperiencePage;
import bcvaxregression22.my.salesforce.com.Tests.BaseTest;
...
public class BookingDose1 extends BaseTest {
    ...
    public void Pre_conditions_step_Remove_Dups_Citizen_participant_account() throws InterruptedException {
        ...
        System.out.println("Searching and Removing Citizen Duplicates BCVAXREGRESSION22");
    ...
    @Test(priority = 2)
    public void Can_Book_Dose1_Appointment_as_Clinician_CIB_BCVAXREGRESSION22() throws InterruptedException {

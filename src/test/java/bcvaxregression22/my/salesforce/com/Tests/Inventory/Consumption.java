...
public class Consumption extends BaseTest {
	...
	public void Pre_conditions_step_Remove_Dups_Citizen_participant_account() throws InterruptedException {
		...
		System.out.println("Searching and Removing Citizen Duplicates REGRESSION");
	...
	@Test(priority = 2)
	public void Validate_Consumption_as_an_Clinician_REGRESSION() throws InterruptedException {

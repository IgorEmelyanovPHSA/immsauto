...
public class E2E_Dose1_Influenza_Pneumo_CP extends BaseTest {
    ...
    public void Can_do_Dose1_Influenza_Pneumo_Vaccine_Administration_as_Clinician_CP() throws Exception {
        ...
        System.out.println("/*42.---Click Save Administration & Record Another Vaccine button --*/");
        inClinicExperience_CP.ClickSaveAdministratorAndRecordAnotherVaccineButton();
        Thread.sleep(5000);

        //click - Confirm on "Do you want to administer another vaccine for this client?" modal screen
        System.out.println("/*43.---Click Confirm Button - to administer another(Pneumo) vaccine --*/");
        inClinicExperience_CP.ClickConfirmAdminAnotherVaccineModalScreenButton();
        Thread.sleep(15000);
        ...
        System.out.println("/*46.---Select Pneumo Lot Number -> T005729-CC07 --*/");
        inClinicExperience_CP.selectPneumoLotNumber();
        Thread.sleep(5000);

        System.out.println("/*47.---Select Route from DropDown -> Intranasal --*/");
        inClinicExperience_CP.selectRouteIntranasal();
        Thread.sleep(5000);

        System.out.println("/*48.---Select Site -> Arm - Right deltoid --*/");
        inClinicExperience_CP.selectSiteLeftDeltoid();
        Thread.sleep(5000);
        ...
        log("/*50.---Click Confirm and Save Administration Button --*/");
        inClinicExperience_CP.ClickConfirmAndSaveAdministrationButton();
        Thread.sleep(5000);

        log("/*51.---Click Modal screen Confirm&Save Administration Button --*/");
        inClinicExperience_CP.ClickModalConfirmAndSaveAdministrationButton();
        Thread.sleep(3000);

        log("/*52.---the Home - Client Search showing up  --*/");
        ...
        inClinicExperience_CP.ValidateCreateImmunizationRecordInfluenzaDisplayed();
        Thread.sleep(2000);
        inClinicExperience_CP.ValidateAfterCareStatusImmunizationRecordInfluenza();
        Thread.sleep(2000);

        log("/*-- 57. Validate Aftercare status for Pneumo --*/");
        inClinicExperience_CP.ValidateCreateImmunizationRecordPneumoDisplayed();
        Thread.sleep(2000);
        inClinicExperience_CP.ValidateAfterCareStatusImmunizationRecordPneumo();
        Thread.sleep(2000);

...
public class Transfer extends BaseTest {
	...
	public void setUpClass() throws Exception {
		...
		log("/----Go to Supply Location where Transferring From and open Related Tab --*/");
	...
	public void Can_do_Transfer_by_Dosages_from_one_Clinic_to_Another_as_PPHIS_Community() throws Exception {
		...
		log("/----Perform Transfer From Location In Popup Window --*/");
		tables.getSupplyLocationActions(supplyContainer);
		supplyConsolePage.selectTransferFromDropDown();

		log("/----Count Conversation Factor and perform doses transfer to another location --*/");
		Thread.sleep(3000);
		...
		log("/----Go to Supply Location where Transferring To an open Related Tab --*/");
		...
		supplyItemName.put(SUPPLY_ITEM_NAME, vaccine);
		Thread.sleep(3000);
		double remainingDoses_before_Distribution_2_1 = tables.getRemainingDoses(supplyContainer);

		log("/----In Transaction Accept Incoming Transfer --*/");
	...
	public void Can_do_Transfer_by_Dosages_within_the_same_Clinic_as_PPHIS_Community() throws Exception {
		...
		log("/----Count Conversation Factor and perform doses transfer to another distribution --*/");
		double dose_conversation_factor = supplyConsolePage.getDoseConversationFactor();
	...
	public void Can_do_Transfer_by_Quantity_within_the_same_Clinic_as_PPHIS_BCVAXDEVIT_Portal() throws Exception {
		...
		log("/----Perform Transfer From Same Location To Another Distribution within same location In Popup --*/");
		tables.getSupplyLocationActions(supplyContainerFromDistributionLocation);
		supplyConsolePage.selectTransferFromDropDown();
		double dose_conversation_factor = supplyConsolePage.getDoseConversationFactor();

...
public class BulkTransfers extends BaseTest {
	...
	public void Can_do_Bulk_transfers_by_Dosages_form_one_Clinic_to_Another_as_PPHIS_BCVAXDEVIT() throws Exception {
		...
		assertEquals(remainingQty_after_Lot_MT0055_Distribution_2_1, ((remainingDoses_before_Lot_MT0055_Distribution_2_1 + 1) / 5));
		...
		assertEquals(remainingQty_after_Lot_EK4241_Distribution_2_1, ((remainingDoses_before_Lot_EK4241_Distribution_2_1 + 1) / 10));
	...
	public void Can_do_Bulk_transfers_by_Quantity_form_one_Clinic_to_Another_as_PPHIS_BCVAXDEVIT() throws Exception {
		...
		log("/*15.----Validate Remaining Doses/Quantities values BEFORE<->AFTER - Automation Location_1 --*/");
		log("/*----Validation for container#1 Distribution_1_1 - VAXZEVRIA (AstraZeneca) - MT0055");
		assertEquals(remainingDoses_after_Lot_MT0055_Distribution_1_1, remainingDoses_before_Lot_MT0055_Distribution_1_1 - 5);
		assertEquals(remainingQty_after_Lot_MT0055_Distribution_1_1, round((remainingDoses_before_Lot_MT0055_Distribution_1_1 - 5) /5),2);
		log("/*----Validation for container#2 Distribution_1_1 - Pfizer mRNA BNT162b2 - EK4241");
		assertEquals(remainingDoses_after_Lot_EK4241_Distribution_1_1, remainingDoses_before_Lot_EK4241_Distribution_1_1 - 10);
		assertEquals(remainingQty_after_Lot_EK4241_Distribution_1_1, round((remainingDoses_before_Lot_EK4241_Distribution_1_1 - 10) / 10),2);
		log("/*----Validation for container#3 Distribution_1_1 - SPIKEVAX 6mo-5y 0.1mg/mL (Moderna) - SPIKEVAX6-5Test001");
		...
		log("/*32.----Validate Remaining Doses/Quantities values BEFORE<->AFTER - Automation Location_1 --*/");
		log("/*----Validation for container#1 Distribution_2_1 - MT0055");
		assertEquals(remainingDoses_after_Lot_MT0055_Distribution_2_1, remainingDoses_before_Lot_MT0055_Distribution_2_1 + 5);
		assertEquals(remainingQty_after_Lot_MT0055_Distribution_2_1, round((remainingDoses_before_Lot_MT0055_Distribution_2_1 + 5) / 5),2);
		log("/*----Validation for container#2 Distribution_2_1 - EK4241");
		assertEquals(remainingDoses_after_Lot_EK4241_Distribution_2_1, remainingDoses_before_Lot_EK4241_Distribution_2_1 + 10);
		assertEquals(remainingQty_after_Lot_EK4241_Distribution_2_1, round((remainingDoses_before_Lot_EK4241_Distribution_2_1 + 10) / 10),2);
		log("/*----Validation for container#3 Distribution_2_1 - SPIKEVAX6-5Test001");

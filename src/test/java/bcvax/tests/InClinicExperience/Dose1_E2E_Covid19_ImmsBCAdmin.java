...
public class Dose1_E2E_Covid19_ImmsBCAdmin extends BaseTest {
	...
	@Test(priority = 1)
	public void Can_do_Dose1_Covid19_Vaccine_Administration_as_ImmsBCAdmin_ICE() throws Exception {
		TestcaseID = "244843"; //C244843

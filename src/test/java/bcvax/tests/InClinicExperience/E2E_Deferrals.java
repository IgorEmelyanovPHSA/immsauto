...
public class E2E_Deferrals extends BaseTest {
    ...
    public void Can_do_Dose1_Vaccine_Administration_as_Clinician_ICE() throws Exception {
        ...
        test_data.setEnv(String.valueOf(testData.get("supplyLocationConsumption")));
        test_data.setDose(String.valueOf(testData.get("administration_dose")));
        test_data.setLot(String.valueOf(testData.get("administration_lot")));
        ...
        test_data.setAgent(String.valueOf(testData.get("administration_agent")));
        log("/*1.----Login --*/");
        try {

...
public class AddAppointmentDays extends BaseTest {
    ...
    public void createAppointmentDays() throws Exception {
        ...
        LocalDate start_date = LocalDate.parse("2023-12-13", dtf);
        LocalDate end_date = LocalDate.parse("2023-12-17", dtf);
        ...
        for(int d = 0; d < appointment_dates.size(); d++) {
            ...
            for (int i = 0; i < providers.size(); i++) {
                ...
                int resp_size = Utilities.ApiQueries.getAppointmentDays(appointment_dates.get(d), appointment_type, appointment_city);
                if (resp_size > 0) {

...
public class Dose1_VaccineAdministration extends BaseTest {
	...
	public void Can_do_Dose1_Vaccine_Administration_as_Clinician_ICE_BCVAXDEVIT() throws InterruptedException {
		...
		Thread.sleep(2000);
		System.out.println("/*10.----Enter Last Name BCVaxLimeburn--*/");
		...
		Thread.sleep(2000);
		System.out.println("/*36----click Verify Contact Information Checkbox  --*/");
		inClinicExperience.clickVerifyContactInformation();
		Thread.sleep(2000);
		System.out.println("/*37----click Confirm Appointment button  --*/");
		inClinicExperience.clickAppointmentConfirmButton();
		Thread.sleep(2000);
		System.out.println("/*38----see 'Appointment Confirmed!' screen --*/");
		inClinicExperience.AppointmentConfirmationMessage();
		Thread.sleep(2000);
		System.out.println("/*39----Refresh page --*/");
		inClinicExperience.refreshBrowser();
		Thread.sleep(2000);
		System.out.println("/*40----Go to back to the Citizen Related Tab --*/");
		inClinicExperience.clickRelatedTab();
		Thread.sleep(2000);
		System.out.println("/*41----click on In-clinic Experience button --*/");
		...
		Thread.sleep(2000);
		System.out.println("/*42----In-clinic Experience ->Vaccine Admin page appears up --*/");
		...
		Thread.sleep(5000);
		System.out.println("/*-- 46---Click Confirm and Save Administration Button --*/");

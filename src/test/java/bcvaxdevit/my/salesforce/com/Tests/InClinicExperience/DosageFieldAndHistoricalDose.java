...
public class DosageFieldAndHistoricalDose extends BaseTest {
    ...
    private String legalFirstName = "Phillip";
    private String legalLastName = "BCVaxShepherd";
    private String dateOfBirth = "May 14, 1947";
    private String postalCode = "V2C2H4";
    private String personalHealthNumber = "9746172076";

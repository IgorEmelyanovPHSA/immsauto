...
//		inClinicExperiencePage.SearchForCitizen("Dacia Bcvaxdod");
//		inClinicExperiencePage.userDaciaFound();
		...
		System.out.println("/*26.1.select covid19 option--*/");
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		System.out.println("/*30----select appointment booking --*/");
		inClinicExperiencePage.clickFacilityOptionLocation();
		Thread.sleep(2000);
		System.out.println("/*31----select Appointment --*/");
		inClinicExperiencePage.selectAppointment();
		Thread.sleep(2000);
		System.out.println("/*32---- select time slot for Appointment--*/");
		inClinicExperiencePage.selectTimeSlotForAppointment();
		Thread.sleep(2000);
		System.out.println("/*33---Click Next Button to Schedule Appointment---*/");
		inClinicExperiencePage.clickNextButtonApptSchedulingPage();
		Thread.sleep(2000);
		System.out.println("/*33---Click Appointment Confirm Button---*/");
		inClinicExperiencePage.clickAppointmentConfirmButton();
		Thread.sleep(2000);
		System.out.println("/*34---Appointment Confirmed! Message Displayed---*/");
		inClinicExperiencePage.AppointmentConfirmationMessage();
		Thread.sleep(2000);
		System.out.println("/*35---Navigate to person account Related Tab---*/");
		inClinicExperiencePage.clickRelatedTab();
		Thread.sleep(2000);
		System.out.println("/*36---Click Go To In clinic experience button---*/");
		inClinicExperiencePage.ClickGoToInClinicExperienceButton();
		Thread.sleep(5000);
		System.out.println("/*37---Click confirm and Save Button on Home Page---*/");
		inClinicExperiencePage.HomePageClickConfirmAndSaveButton();
		Thread.sleep(5000);
		System.out.println("/*38---Click Save Consent Button---*/");
		inClinicExperiencePage.ClickSaveConsentButton();
		Thread.sleep(5000);
		System.out.println("/*39---Click Confirm and Save Administration Button---*/");
		inClinicExperiencePage.ClickConfirmAndSaveAdministrationButton();
		Thread.sleep(3000);
		System.out.println("/*----40. Navigate to Health Connect - Supply Console --*/");
		inClinicExperiencePage.selectHealthConnectApp();
		Thread.sleep(2000);
		inClinicExperiencePage.closeTabsHCA();
		System.out.println("/*----41. Close all open tabs --*/");
		Thread.sleep(2000);
		System.out.println("/*----42. Click Dropdown Menu --*/");
		inClinicExperiencePage.clickDropdownMenu();
		Thread.sleep(5000);
		System.out.println("/*----43. Navigate and Select Supply Locations --*/");
		inClinicExperiencePage.selectSupplyLocationFromDropdown();
		Thread.sleep(2000);
		System.out.println("/*----44. Locate and click Age 12 and Above - Coquitlam - Lincoln Pharmacy & Coquitlam Travel Clinic location --*/");
		inClinicExperiencePage.selectSupplyLocationName();
		Thread.sleep(2000);
		System.out.println("/*----45. Click and navigate to the supply container --> 'Medicago TradeName - MedicagoTestLot001'--*/");
		inClinicExperiencePage.selectSupplyContainer();
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		inClinicExperiencePage.closeTabsHCA();
		System.out.println("/*----48. Close all open tabs --*/");

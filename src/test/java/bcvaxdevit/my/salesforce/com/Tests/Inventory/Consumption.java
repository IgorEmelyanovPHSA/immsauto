...
public class Consumption extends BaseTest {
	...
	public void Validate_Consumption_as_an_Clinician_BCVAXDEVIT() throws InterruptedException {
		...
		inClinicExperiencePage.closeTabsHCA();
		System.out.println("/*-- 5. Close all open tabs --*/");
		Thread.sleep(2000);
		System.out.println("/*-- 6. Locate and click Age 12 and Above - Coquitlam - Lincoln Pharmacy & Coquitlam Travel Clinic location --*/");
		inClinicExperiencePage.selectSupplyLocationName();
		Thread.sleep(2000);
		System.out.println("/*-- 7. Click and navigate to the supply container --> 'Medicago TradeName - MedicagoTestLot001' --*/");
		inClinicExperiencePage.selectSupplyContainer();
		Thread.sleep(2000);
		String remainingDoses = inClinicExperiencePage.getValueOfRemainingDoses();
		System.out.println("/*-- 8. remaining doses are: -->" + remainingDoses);
		Thread.sleep(2000);
		String remainingQty = inClinicExperiencePage.getValueOfRemainingQty();
		System.out.println("/*-- 9. remaining doses are: -->" + remainingQty);
		Thread.sleep(2000);
		inClinicExperiencePage.closeTabsHCA();
		System.out.println("/*-- 10. Close all open tabs --*/");
		Thread.sleep(2000);
		inClinicExperiencePage.selectICEFromApp();
		System.out.println("/*-- 11. Navigate to In Clinic Experience App --*/");
		Thread.sleep(2000);
		inClinicExperiencePage.clickRegisterTab();
		System.out.println("/*-- 12. Click on register Tab --*/");
		inClinicExperiencePage.closeTabsHCA();
		System.out.println("/*-- 13. Close any open Tabs --*/");
		inClinicExperiencePage.clickRegisterButton();
		System.out.println("/*-- 14. Register New User --> Dacia --*/");
		String firstName = "Dacia";
		inClinicExperiencePage.enterFirstName(firstName);
		System.out.println("/*-- 15.----Enter First Name Dacia --*/");
		Thread.sleep(2000);
		String lastName = "Bcvaxdod";
		inClinicExperiencePage.enterLastName(lastName);
		System.out.println("/*-- 16.----Enter Last Name Bcvaxdod --*/");
		Thread.sleep(2000);
		String dateOfBirth = "May 19, 1904";//1904-05-19
		inClinicExperiencePage.enterDateOfBirth(dateOfBirth);
		System.out.println("/*-- 17.----Enter Date of birth --*/");
		Thread.sleep(2000);
		String postalCode = "V7N3K1";
		inClinicExperiencePage.enterPostalCode(postalCode);
		System.out.println("/*-- 18.----Enter Postal code --*/");
		Thread.sleep(2000);
		String phnNumber = "9746172456";
		inClinicExperiencePage.enterPNH(phnNumber);
		System.out.println("/*-- 19.----Enter PHN --*/");
		Thread.sleep(2000);
		inClinicExperiencePage.clickNonIndigenousRadioButton();
		System.out.println("/*-- 20.----click on non-Indigenous person radiobutton --*/");
		Thread.sleep(2000);
		inClinicExperiencePage.clickVerifyPHNButton();
		System.out.println("/*-- 21.----click Verify PHN button --*/");
		Thread.sleep(2000);
		inClinicExperiencePage.successMessage();
		System.out.println("/*-- 22.'PNH match successful' --*/");
		inClinicExperiencePage.clickNextButton();
		System.out.println("/*-- 23.'Click next button --*/");
		Thread.sleep(5000);
		String email = "test@qa.com";
		inClinicExperiencePage.enterEmail(email);
		System.out.println("/*-- 24.'Enter email address --*/");
		Thread.sleep(2000);
		String email1 = "test@qa.com";
		inClinicExperiencePage.confirmEmail(email1);
		System.out.println("/*-- 25.'Confirm email address --*/");
		Thread.sleep(2000);
		inClinicExperiencePage.clickReviewDetails();
		System.out.println("/*-- 26.Click review details Button --*/");
		Thread.sleep(2000);
		inClinicExperiencePage.clickRegisterButtonOnConfirmationPage();
		System.out.println("/*-- 27.Click register Button on confirmation page --*/");
		Thread.sleep(5000);
		...
		System.out.println("/*-- 29.Click on reason for visit --*/");
		Thread.sleep(2000);

...
public class BulkTransfers extends BaseTest {
	...
	public void Can_do_Bulk_transfers_by_Quantity_form_one_Clinic_to_Another_as_PPHIS_BCVAXDEVIT() throws Exception {
		...
		assertEquals(remainingQty_after_Lot_MT0055_Distribution_1_1, ((remainingDoses_before_Lot_MT0055_Distribution_1_1 - 10) / 10));
		log("/*----Validation for container#2 Distribution_1_1 - Pfizer mRNA BNT162b2 - EK4241");
		...
		assertEquals(remainingQty_after_Lot_SPIKEVAX6_5Test001_Distribution_1_1, ((remainingDoses_before_Lot_SPIKEVAX6_5Test001_Distribution_1_1 - 10) / 10));
		Thread.sleep(2000);
		log("/*16.----Go to Transactions Tab of Automation Supply Location_1 --*/");
		supplyConsolePage.clickTransactionsTab();
		Thread.sleep(5000);
		...
		assertEquals(remainingQty_after_Lot_MT0055_Distribution_2_1, ((remainingDoses_before_Lot_MT0055_Distribution_2_1 + 10) / 10));
		log("/*----Validation for container#2 Distribution_2_1 - EK4241");
		assertEquals(remainingDoses_after_Lot_EK4241_Distribution_2_1, remainingDoses_before_Lot_EK4241_Distribution_2_1 + 5);
		assertEquals(remainingQty_after_Lot_EK4241_Distribution_2_1, ((remainingDoses_before_Lot_EK4241_Distribution_2_1 + 5) / 5));
		log("/*----Validation for container#3 Distribution_2_1 - SPIKEVAX6-5Test001");
	...
	public void Can_do_Bulk_transfers_by_Dosages_within_the_same_Clinic_as_PPHIS_BCVAXDEVIT() throws Exception {
		...
		assertEquals(remainingQty_after_Lot_MT0055_Distribution_1_2, ((remainingDoses_before_Lot_MT0055_Distribution_1_2 + 1) / 10));

...
public class BulkTransfers extends BaseTest {
	...
	public void Can_do_Bulk_transfers_by_Dosages_form_one_Clinic_to_Another_as_PPHIS_BCVAXDEVIT() throws InterruptedException {
		...
		log("/*- container#1 - Supply Distribution_2_1 & Pfizer mRNA BNT162b2 - EK4241*/");
		double remainingDoses_before_Lot_EK4241_Distribution_2_1 = supplyConsolePage.getValueOfRemainingDoses_Container1_Distribution_1_1();
		log("/*-- . remaining doses are: -->" + remainingDoses_before_Lot_EK4241_Distribution_2_1);
		Thread.sleep(2000);
		double remainingQty_before_Lot_EK4241_Distribution_2_1 = supplyConsolePage.getValueOfRemainingQty_Container1_Distribution_1_1();
		log("/*-- . remaining Quantity are: -->" + remainingQty_before_Lot_EK4241_Distribution_2_1);
		log("/*- container#2 - Supply Distribution_2_1 & Pfizer mRNA BNT162b2 - EL0203*/");
		double remainingDoses_before_Lot_EL0203_Distribution_2_1 = supplyConsolePage.getValueOfRemainingDoses_Container2_Distribution_1_1();
		log("/*-- . remaining Doses are: -->" + remainingDoses_before_Lot_EL0203_Distribution_2_1);
		Thread.sleep(2000);
		double remainingQty_before_Lot_EL0203_Distribution_2_1 = supplyConsolePage.getValueOfRemainingQty_Container2_Distribution_1_1();
		log("/*-- . remaining Quantity are: -->" + remainingQty_before_Lot_EL0203_Distribution_2_1);
		...
		log("/*- container#1 - Supply Distribution_2_1 & Pfizer mRNA BNT162b2 - EK4241*/");
		double remainingDoses_after_Lot_EK4241_Distribution_2_1 = supplyConsolePage.getValueOfRemainingDoses_Container1_Distribution_1_1();
		log("/*-- . remaining doses are: -->" + remainingDoses_after_Lot_EK4241_Distribution_2_1);
		Thread.sleep(2000);
		double remainingQty_after_Lot_EK4241_Distribution_2_1 = supplyConsolePage.getValueOfRemainingQty_Container1_Distribution_1_1();
		log("/*-- . remaining Quantity are: -->" + remainingQty_after_Lot_EK4241_Distribution_2_1);
		log("/*- container#2 - Supply Distribution_2_1 & Pfizer mRNA BNT162b2 - EL0203*/");
		double remainingDoses_after_Lot_EL0203_Distribution_2_1 = supplyConsolePage.getValueOfRemainingDoses_Container2_Distribution_1_1();
		log("/*-- . remaining Doses are: -->" + remainingDoses_after_Lot_EL0203_Distribution_2_1);
		Thread.sleep(2000);
		double remainingQty_after_Lot_EL0203_Distribution_2_1 = supplyConsolePage.getValueOfRemainingQty_Container2_Distribution_1_1();
		log("/*-- . remaining Quantity are: -->" + remainingQty_after_Lot_EL0203_Distribution_2_1);
		...
		log("/*----Validation for container#1 Distribution_2_1 - EK4241");
		assertEquals(remainingDoses_after_Lot_EK4241_Distribution_2_1, remainingDoses_before_Lot_EK4241_Distribution_2_1 + 2);
		assertEquals(remainingQty_after_Lot_EK4241_Distribution_2_1, ((remainingDoses_before_Lot_EK4241_Distribution_2_1 + 2) / 5));
		log("/*----Validation for container#2 Distribution_2_1 - EL0203");
		assertEquals(remainingDoses_after_Lot_EL0203_Distribution_2_1, remainingDoses_before_Lot_EL0203_Distribution_2_1 + 1);
		assertEquals(remainingQty_after_Lot_EL0203_Distribution_2_1, ((remainingDoses_before_Lot_EL0203_Distribution_2_1 + 1) / 5));
	...
	public void Can_do_Bulk_transfers_by_Quantity_form_one_Clinic_to_Another_as_PPHIS_BCVAXDEVIT() throws InterruptedException {
		...
		assertEquals(remainingQty_after_Lot_EK4241_Distribution_1_1, ((remainingDoses_before_Lot_EK4241_Distribution_1_1 - 5) / 5));
		log("/*----Validation for container#2 Distribution_1_1 - EL0203");
		assertEquals(remainingDoses_after_Lot_EL0203_Distribution_1_1, remainingDoses_before_Lot_EL0203_Distribution_1_1 - 5);
		assertEquals(remainingQty_after_Lot_EL0203_Distribution_1_1, ((remainingDoses_before_Lot_EL0203_Distribution_1_1 - 5) / 5));
		log("/*----Validation for container#3 Distribution_1_2 - EK4241");
		assertEquals(remainingDoses_after_Lot_EK4241_Distribution_1_2, remainingDoses_before_Lot_EK4241_Distribution_1_2 - 5);
		assertEquals(remainingQty_after_Lot_EK4241_Distribution_1_2, ((remainingDoses_before_Lot_EK4241_Distribution_1_2 - 5) / 5));
		Thread.sleep(2000);
		log("/*16.----Go to Transactions Tab of Automation Supply Location_1 --*/");
		supplyConsolePage.clickTransactionsTab();
		Thread.sleep(5000);
		...
		log("/*32.----Validate Remaining Doses/Quantities values BEFORE<->AFTER - Automation Location_1 --*/");
		log("/*----Validation for container#1 Distribution_2_1 - EK4241");
		assertEquals(remainingDoses_after_Lot_EK4241_Distribution_2_1, remainingDoses_before_Lot_EK4241_Distribution_2_1 + 2*5);
		assertEquals(remainingQty_after_Lot_EK4241_Distribution_2_1, ((remainingDoses_before_Lot_EK4241_Distribution_2_1 + 2*5) / 5));
		log("/*----Validation for container#2 Distribution_2_1 - EL0203");
		assertEquals(remainingDoses_after_Lot_EL0203_Distribution_2_1, remainingDoses_before_Lot_EL0203_Distribution_2_1 + 5);
		assertEquals(remainingQty_after_Lot_EL0203_Distribution_2_1, ((remainingDoses_before_Lot_EL0203_Distribution_2_1 + 5) / 5));
		log("/*33----Close Automation_Supply_Location_2 Tab --*/");
		supplyConsolePage.closeAutomationLocationTab();
		Thread.sleep(5000);
	}

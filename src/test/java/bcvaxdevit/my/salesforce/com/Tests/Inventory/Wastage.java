...
public class Wastage extends BaseTest {
    ...
    @Test
    public void inventoryManagementWastageByDosagesAS_PPHIS_BCVAXDEVIT() throws InterruptedException {
        TestcaseID = "220550"; //Need to update TestCaseID //C219942 Python -> Java

...
public class Wastage extends BaseTest {
    ...
    @Story("222357: Wastage single dose")
    @Test(groups = {"Smoke"})
    public void Can_Do_Single_Wastage_ByDosages_AS_PPHIS_BCVAXDEVIT(ITestContext context) throws Exception {
        TestcaseID = "222357"; //C222357

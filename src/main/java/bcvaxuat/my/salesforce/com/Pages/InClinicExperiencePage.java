...
public class InClinicExperiencePage extends BasePage {
   ...
   /* @FindBy(xpath = ".//a[@title = 'Register']")
	...
	@FindBy(xpath = ".//a[@title='BARBIE MIDDLENAMELABB Labflastnametestroberts']")
	private WebElement user_found;
	private By user_found1 = By.xpath(".//a[@title='BARBIE MIDDLENAMELABB Labflastnametestroberts']");
